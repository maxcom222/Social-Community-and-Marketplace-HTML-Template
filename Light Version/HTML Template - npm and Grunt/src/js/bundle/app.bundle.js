...
"use strict";var plugins=require('../utils/plugins');/*-----------------------
    EXP TO NEXT LEVEL
-----------------------*/plugins.createProgressBar({container:'#exp-to-next-level',height:6,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#exp-to-next-level',height:6,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:200,stop:162},linkText:true,linkUnits:'exp',invertedProgress:true,animateOnScroll:true});/*----------------
    BADGE ITEM
----------------*/plugins.createProgressBar({container:'#badge-bronze',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-bronze',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:1,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-silver',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-silver',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:100},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-gold',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-gold',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:500,stop:461},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-platinum',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-platinum',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:1000,stop:461},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-traveller',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-traveller',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:5,stop:4},invertedProgress:true,linkText:true,linkUnits:'topics',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-caffeinated',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-caffeinated',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:1,stop:0},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-upowered',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-upowered',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:50,stop:42},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-scientist',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-scientist',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:1,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-ncreature',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-ncreature',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:100},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-warrior',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-warrior',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:1,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-liked',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-liked',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:500,stop:462},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-sloved',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-sloved',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:1000,stop:462},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-qconq',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-qconq',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:10,stop:4},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-villain',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-villain',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:89},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-age',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-age',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:730,stop:605},invertedProgress:true,linkText:true,linkUnits:'days',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-tstruck',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-tstruck',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:50,stop:41},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-uexp',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-uexp',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:20,stop:17},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-globet',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-globet',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:10,stop:8},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-verifieds',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-verifieds',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:1,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-gempost',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-gempost',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:1,stop:0},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-peoplesp',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-peoplesp',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:200,stop:181},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-rulerm',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-rulerm',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:5,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-marketeer',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-marketeer',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:10,stop:7},invertedProgress:true,linkText:true,linkUnits:'items',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-tycoon',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-tycoon',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:32},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-mightiers',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-mightiers',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:50,stop:26},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-phantom',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-phantom',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:1,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-forumsf',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-forumsf',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:20,stop:13},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-fcultivator',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-fcultivator',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:33},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-splanner',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-splanner',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:25,stop:9},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-collector',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-collector',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:5,stop:2},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-prophoto',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-prophoto',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:500,stop:24},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-rmachine',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-rmachine',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:50,stop:41},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-bronzec',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-bronzec',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:1,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-silverc',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-silverc',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:1,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-goldc',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-goldc',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:1,stop:1},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});plugins.createProgressBar({container:'#badge-platinumc',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#badge-platinumc',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:1,stop:0},linkText:true,linkUnits:'/',emptyText:'locked',completeText:'unlocked!'});/*-------------------
    QUEST PREVIEW
-------------------*/plugins.createProgressBar({container:'#quest-preview-nth',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-preview-nth',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:65},animateOnScroll:true});plugins.createProgressBar({container:'#quest-preview-sk',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-preview-sk',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:85},animateOnScroll:true});plugins.createProgressBar({container:'#quest-preview-bp',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-preview-bp',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:32},animateOnScroll:true});plugins.createProgressBar({container:'#quest-preview-htp',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-preview-htp',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:0},animateOnScroll:true});plugins.createProgressBar({container:'#quest-preview-sm',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-preview-sm',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:49},animateOnScroll:true});plugins.createProgressBar({container:'#quest-sk',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-sk',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:8,stop:7},linkText:true,linkUnits:'/'});plugins.createProgressBar({container:'#quest-fu',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-fu',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:50,stop:50},linkText:true,linkUnits:'/'});plugins.createProgressBar({container:'#quest-nth',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-nth',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:67},linkText:true,linkUnits:'%'});plugins.createProgressBar({container:'#quest-sm',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-sm',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:10,stop:5},linkText:true,linkUnits:'/'});plugins.createProgressBar({container:'#quest-line-ps',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-line-ps',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:100},linkText:true,linkUnits:'%',animateOnScroll:true});plugins.createProgressBar({container:'#quest-line-nth',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-line-nth',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:67},linkText:true,linkUnits:'%',animateOnScroll:true});plugins.createProgressBar({container:'#quest-line-fu',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-line-fu',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:50,stop:50},linkText:true,linkUnits:'/',animateOnScroll:true});plugins.createProgressBar({container:'#quest-line-ph',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-line-ph',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:20,stop:20},linkText:true,linkUnits:'/',animateOnScroll:true});plugins.createProgressBar({container:'#quest-line-tr',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-line-tr',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:10,stop:2},linkText:true,linkUnits:'/',animateOnScroll:true});plugins.createProgressBar({container:'#quest-line-sk',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-line-sk',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:8,stop:7},linkText:true,linkUnits:'/',animateOnScroll:true});plugins.createProgressBar({container:'#quest-line-bp',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-line-bp',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:30,stop:12},linkText:true,linkUnits:'/',animateOnScroll:true});plugins.createProgressBar({container:'#quest-line-htp',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-line-htp',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:0},linkText:true,linkUnits:'%',animateOnScroll:true});plugins.createProgressBar({container:'#quest-line-sm',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#quest-line-sm',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:10,stop:5},linkText:true,linkUnits:'/',animateOnScroll:true});/*------------------
    POLL RESULT
------------------*/plugins.createProgressBar({container:'#poll-result-1',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#poll-result-1',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:62},linkText:true,linkUnits:'%'});plugins.createProgressBar({container:'#poll-result-2',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#poll-result-2',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:27},linkText:true,linkUnits:'%'});plugins.createProgressBar({container:'#poll-result-3',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#poll-result-3',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:11},linkText:true,linkUnits:'%'});/*---------------------
    POST ENGAGEMENT
---------------------*/plugins.createProgressBar({container:'#post-engagement-1',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#post-engagement-1',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:89},linkText:true,linkUnits:'%',animateOnScroll:true});plugins.createProgressBar({container:'#post-engagement-2',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#post-engagement-2',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:74},linkText:true,linkUnits:'%',animateOnScroll:true});plugins.createProgressBar({container:'#post-engagement-3',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#post-engagement-3',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:53},linkText:true,linkUnits:'%',animateOnScroll:true});plugins.createProgressBar({container:'#post-engagement-4',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#post-engagement-4',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:48},linkText:true,linkUnits:'%',animateOnScroll:true});plugins.createProgressBar({container:'#post-engagement-5',height:4,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#post-engagement-5',height:4,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:100,stop:21},linkText:true,linkUnits:'%',animateOnScroll:true});/*-----------------
    TOP COUNTRY
-----------------*/plugins.createProgressBar({container:'#top-country-1',width:178,height:6,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#top-country-1',width:178,height:6,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:25362,stop:25362},split:{parts:30,gap:2,color:'#fff'},linkText:true,linkUnits:false,animateOnScroll:true});plugins.createProgressBar({container:'#top-country-2',width:178,height:6,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#top-country-2',width:178,height:6,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:25362,stop:18201},split:{parts:30,gap:2,color:'#fff'},linkText:true,linkUnits:false,animateOnScroll:true});plugins.createProgressBar({container:'#top-country-3',width:178,height:6,lineColor:'#e7e8ee'});plugins.createProgressBar({container:'#top-country-3',width:178,height:6,gradient:{colors:['#615dfa','#41efff']},scale:{start:0,end:25362,stop:9567},split:{parts:30,gap:2,color:'#fff'},linkText:true,linkUnits:false,animateOnScroll:true});
...
------------------------------*/app.querySelector('#ve-monthly-report-chart',function(el){var datasetData1=[20,15,22,26,12,16,24,13,17,9,26,21,14,21,17,23,30,18,24,15,28,17,13,23,16,12,23,16,24,13,22],datasetData2=[9,28,6,9,17,7,16,12,10,11,12,3,13,11,8,17,13,16,5,19,14,11,26,8,4,15,16,25,5,13,12],canvas=el[0],ctx=canvas.getContext('2d'),chartData={labels:getLabelNumbers(31),datasets:[{label:'Engagements',data:datasetData1,maxBarThickness:16,backgroundColor:'#615dfa'},{label:'Visits',data:datasetData2,maxBarThickness:16,backgroundColor:'#3ad2fe'},{data:getCompleterData([datasetData1,datasetData2],55),maxBarThickness:16,backgroundColor:'#e8e8ef'}]},chartOptions={responsive:true,maintainAspectRatio:false,legend:{display:false},tooltips:{bodyFontFamily:"'Titillium Web', sans-serif",displayColors:false,callbacks:{title:function title(){}}},scales:{xAxes:[{stacked:true,gridLines:{display:false},ticks:{fontFamily:"'Rajdhani', sans-serif",fontColor:'#8f91ac',fontSize:12,fontStyle:500}}],yAxes:[{stacked:true,gridLines:{color:"rgba(234, 234, 245, 1)",zeroLineColor:"rgba(234, 234, 245, 1)",drawBorder:false,drawTicks:false},ticks:{padding:20,fontFamily:"'Rajdhani', sans-serif",fontColor:'#8f91ac',fontSize:12,fontStyle:500,max:55,stepSize:5}}]}};plugins.createChart(ctx,{type:'bar',data:chartData,options:chartOptions});});/*-----------------------------
    RC YEARLY REPORT CHART
-----------------------------*/app.querySelector('#rc-yearly-report-chart',function(el){var datasetData1=[119,142,110,122,163,139,143,110,141,121,139,190],datasetData2=[98,65,132,78,112,82,100,80,100,58,48,139],canvas=el[0],ctx=canvas.getContext('2d'),chartData={labels:['January','February','March','April','May','June','July','August','September','October','November','December'],datasets:[{label:'Reactions',data:datasetData1,fill:false,lineTension:0,borderWidth:4,borderColor:"#23d2e2",borderCapStyle:'butt',borderDash:[],borderDashOffset:0,borderJoinStyle:'bevel',pointBorderColor:"#23d2e2",pointBackgroundColor:"#fff",pointBorderWidth:4,pointHoverRadius:5,pointHoverBackgroundColor:"#fff",pointHoverBorderColor:"#23d2e2",pointHoverBorderWidth:4,pointRadius:5,pointHitRadius:10},{label:'Comments',data:datasetData2,fill:false,lineTension:0,borderWidth:4,borderColor:"#4f91ff",borderCapStyle:'bevel',borderDash:[],borderDashOffset:0,borderJoinStyle:'bevel',pointBorderColor:"#4f91ff",pointBackgroundColor:"#fff",pointBorderWidth:4,pointHoverRadius:5,pointHoverBackgroundColor:"#fff",pointHoverBorderColor:"#4f91ff",pointHoverBorderWidth:4,pointRadius:5,pointHitRadius:10}]},chartOptions={responsive:true,maintainAspectRatio:false,legend:{display:false},tooltips:{bodyFontFamily:"'Titillium Web', sans-serif",displayColors:false,callbacks:{title:function title(){}}},scales:{xAxes:[{gridLines:{color:"rgba(234, 234, 245, 1)",zeroLineColor:"rgba(234, 234, 245, 1)",drawBorder:false,drawTicks:false},ticks:{padding:14,fontFamily:"'Rajdhani', sans-serif",fontColor:'#8f91ac',fontSize:12,fontStyle:500}}],yAxes:[{gridLines:{color:"rgba(234, 234, 245, 1)",zeroLineColor:"rgba(234, 234, 245, 1)",drawBorder:false},ticks:{padding:20,fontFamily:"'Rajdhani', sans-serif",fontColor:'#8f91ac',fontSize:12,fontStyle:500,min:20,max:220,stepSize:40}}]}};plugins.createChart(ctx,{type:'line',data:chartData,options:chartOptions});});/*---------------------------
    VS PERFORMANCE CHART
---------------------------*/app.querySelector('#vs-performance-chart',function(el){var datasetData1=[140,90,155,180],datasetData2=[120,25,130,110],canvas=el[0],ctx=canvas.getContext('2d'),chartData={labels:['Aug','Sep','Oct','Nov'],datasets:[{label:'Views',data:datasetData1,maxBarThickness:16,backgroundColor:'#615dfa'},{label:'Sales',data:datasetData2,maxBarThickness:16,backgroundColor:'#3ad2fe'}]},chartOptions={responsive:true,maintainAspectRatio:false,legend:{display:false},tooltips:{bodyFontFamily:"'Titillium Web', sans-serif",displayColors:false,callbacks:{title:function title(){}}},scales:{xAxes:[{gridLines:{display:false},ticks:{fontFamily:"'Rajdhani', sans-serif",fontColor:'#8f91ac',fontSize:12,fontStyle:500}}],yAxes:[{gridLines:{display:false},ticks:{display:false}}]}};plugins.createChart(ctx,{type:'bar',data:chartData,options:chartOptions});});/*---------------------------
    EARNINGS REPORT CHART
---------------------------*/app.querySelector('#earnings-report-chart',function(el){var datasetData=[0,15,0,0,0,20,10,15,40,20,25,25,15,10,20,23,23,15,30,40,30,20,25,0,0,0,0,0,0,0,0,0],canvas=el[0],ctx=canvas.getContext('2d'),chartData={labels:getLabelNumbers(31),datasets:[{label:'Earnings',data:datasetData,lineTension:.5,borderWidth:2,backgroundColor:'rgba(35, 210, 226, .2)',borderColor:"#23d2e2",borderCapStyle:'butt',borderDash:[],borderDashOffset:0,borderJoinStyle:'bevel',pointBorderColor:"#fff",pointBackgroundColor:"#23d2e2",pointBorderWidth:2,pointHoverRadius:4,pointHoverBorderColor:"#fff",pointHoverBackgroundColor:"#23d2e2",pointHoverBorderWidth:2,pointRadius:4,pointHitRadius:5}]},chartOptions={responsive:true,maintainAspectRatio:false,legend:{display:false},tooltips:{bodyFontFamily:"'Titillium Web', sans-serif",displayColors:false,callbacks:{title:function title(){}}},scales:{xAxes:[{gridLines:{color:"rgba(234, 234, 245, 1)",zeroLineColor:"rgba(234, 234, 245, 1)",drawBorder:false,drawTicks:false},ticks:{padding:14,fontFamily:"'Rajdhani', sans-serif",fontColor:'#8f91ac',fontSize:12,fontStyle:500}}],yAxes:[{gridLines:{color:"rgba(234, 234, 245, 1)",zeroLineColor:"rgba(234, 234, 245, 1)",drawBorder:false},ticks:{padding:20,fontFamily:"'Rajdhani', sans-serif",fontColor:'#8f91ac',fontSize:12,fontStyle:500,max:55,stepSize:5,callback:function callback(value,index,values){return'$'+value;}}}]}};plugins.createChart(ctx,{type:'line',data:chartData,options:chartOptions});});/*---------------------------
    MEMBERS REPORT CHART
---------------------------*/app.querySelector('#members-report-chart',function(el){var datasetData=[8,4,8,5,10,13,11,11,13,17,5,12],canvas=el[0],ctx=canvas.getContext('2d'),chartData={labels:['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'],datasets:[{label:'Members',data:datasetData,lineTension:0,borderWidth:2,backgroundColor:'rgba(97, 93, 250, .1)',borderColor:"#615dfa",borderCapStyle:'butt',borderDash:[],borderDashOffset:0,borderJoinStyle:'bevel',pointBorderColor:"#615dfa",pointBackgroundColor:"#fff",pointBorderWidth:2,pointHoverRadius:4,pointHoverBorderColor:"#615dfa",pointHoverBackgroundColor:"#fff",pointHoverBorderWidth:2,pointRadius:4,pointHitRadius:5}]},chartOptions={responsive:true,maintainAspectRatio:false,legend:{display:false},tooltips:{bodyFontFamily:"'Titillium Web', sans-serif",displayColors:false,callbacks:{title:function title(){}}},scales:{xAxes:[{gridLines:{color:"rgba(234, 234, 245, 1)",zeroLineColor:"rgba(234, 234, 245, 1)",drawBorder:false,drawTicks:false},ticks:{padding:14,fontFamily:"'Rajdhani', sans-serif",fontColor:'#8f91ac',fontSize:12,fontStyle:500}}],yAxes:[{gridLines:{color:"rgba(234, 234, 245, 1)",zeroLineColor:"rgba(234, 234, 245, 1)",drawBorder:false},ticks:{padding:20,fontFamily:"'Rajdhani', sans-serif",fontColor:'#8f91ac',fontSize:12,fontStyle:500,max:20,stepSize:2,beginAtZero:true}}]}};plugins.createChart(ctx,{type:'line',data:chartData,options:chartOptions});});
...
"use strict";var plugins=require('../utils/plugins');plugins.createHexagon({container:'.hexagon-148-164',width:148,height:164,roundedCorners:true,fill:true});plugins.createHexagon({container:'.hexagon-progress-124-136',width:124,height:136,lineWidth:8,roundedCorners:true,gradient:{colors:['#41efff','#615dfa']},scale:{start:0,end:1,stop:.74}});plugins.createHexagon({container:'.hexagon-border-124-136',width:124,height:136,lineWidth:8,roundedCorners:true,lineColor:'#e7e8ee'});plugins.createHexagon({container:'.hexagon-image-100-110',width:100,height:110,roundedCorners:true,clip:true});plugins.createHexagon({container:'.hexagon-120-132',width:120,height:132,roundedCorners:true,fill:true});plugins.createHexagon({container:'.hexagon-progress-100-110',width:100,height:110,lineWidth:6,roundedCorners:true,gradient:{colors:['#41efff','#615dfa']},scale:{start:0,end:1,stop:.8}});plugins.createHexagon({container:'.hexagon-border-100-110',width:100,height:110,lineWidth:6,roundedCorners:true,lineColor:'#e7e8ee'});plugins.createHexagon({container:'.hexagon-image-82-90',width:82,height:90,roundedCorners:true,roundedCornerRadius:3,clip:true});plugins.createHexagon({container:'.hexagon-100-110',width:100,height:110,roundedCorners:true,fill:true});plugins.createHexagon({container:'.hexagon-progress-84-92',width:84,height:92,lineWidth:5,roundedCorners:true,roundedCornerRadius:3,gradient:{colors:['#41efff','#615dfa']},scale:{start:0,end:1,stop:.8}});plugins.createHexagon({container:'.hexagon-border-84-92',width:84,height:92,lineWidth:5,roundedCorners:true,roundedCornerRadius:3,lineColor:'#e7e8ee'});plugins.createHexagon({container:'.hexagon-image-68-74',width:68,height:74,roundedCorners:true,roundedCornerRadius:3,clip:true});plugins.createHexagon({container:'.hexagon-50-56',width:50,height:56,roundedCorners:true,roundedCornerRadius:2,fill:true});plugins.createHexagon({container:'.hexagon-progress-40-44',width:40,height:44,lineWidth:3,roundedCorners:true,roundedCornerRadius:1,gradient:{colors:['#41efff','#615dfa']},scale:{start:0,end:1,stop:.8}});plugins.createHexagon({container:'.hexagon-border-40-44',width:40,height:44,lineWidth:3,roundedCorners:true,roundedCornerRadius:1,lineColor:'#e7e8ee'});plugins.createHexagon({container:'.hexagon-image-30-32',width:30,height:32,roundedCorners:true,roundedCornerRadius:1,clip:true});plugins.createHexagon({container:'.hexagon-40-44',width:40,height:44,roundedCorners:true,roundedCornerRadius:1,fill:true});plugins.createHexagon({container:'.hexagon-dark-32-34',width:32,height:34,roundedCorners:true,roundedCornerRadius:1,lineColor:'#45437f',fill:true});plugins.createHexagon({container:'.hexagon-32-36',width:32,height:36,roundedCorners:true,roundedCornerRadius:1,lineColor:'#fff',fill:true});plugins.createHexagon({container:'.hexagon-dark-26-28',width:26,height:28,roundedCorners:true,roundedCornerRadius:1,lineColor:'#45437f',fill:true});plugins.createHexagon({container:'.hexagon-28-32',width:28,height:32,roundedCorners:true,roundedCornerRadius:1,lineColor:'#fff',fill:true});plugins.createHexagon({container:'.hexagon-dark-22-24',width:22,height:24,roundedCorners:true,roundedCornerRadius:1,lineColor:'#45437f',fill:true});plugins.createHexagon({container:'.hexagon-22-24',width:22,height:24,roundedCorners:true,roundedCornerRadius:1,lineColor:'#fff',fill:true});plugins.createHexagon({container:'.hexagon-dark-16-18',width:16,height:18,roundedCorners:true,roundedCornerRadius:1,lineColor:'#45437f',fill:true});plugins.createHexagon({container:'.hexagon-120-130',width:120,height:130,roundedCorners:true,fill:true});plugins.createHexagon({container:'.hexagon-100-108',width:100,height:108,roundedCorners:true,fill:true});plugins.createHexagon({container:'.hexagon-image-124-136',width:124,height:136,roundedCorners:true,clip:true});plugins.createHexagon({container:'.hexagon-image-84-92',width:84,height:92,roundedCorners:true,clip:true});plugins.createHexagon({container:'.hexagon-34-36',width:34,height:36,roundedCorners:true,roundedCornerRadius:1,fill:true});plugins.createHexagon({container:'.hexagon-image-40-44',width:40,height:44,roundedCorners:true,roundedCornerRadius:1,clip:true});plugins.createHexagon({container:'.hexagon-image-24-26',width:24,height:26,roundedCorners:true,roundedCornerRadius:1,clip:true});plugins.createHexagon({container:'.hexagon-image-18-20',width:18,height:20,roundedCorners:true,roundedCornerRadius:1,clip:true});plugins.createHexagon({container:'.hexagon-overlay-30-32',width:30,height:32,roundedCorners:true,roundedCornerRadius:1,lineColor:'rgba(97, 93, 250, .9)',fill:true});
...
"use strict";var plugins=require('../utils/plugins');plugins.createProgressBar({container:'#logged-user-level',height:4,lineColor:'#4a46c8'});plugins.createProgressBar({container:'#logged-user-level',height:4,lineColor:'#41efff',scale:{start:0,end:100,stop:62},linkText:true,linkUnits:'exp',invertedProgress:true});plugins.createProgressBar({container:'#logged-user-level-cp',height:4,lineColor:'#4a46c8'});plugins.createProgressBar({container:'#logged-user-level-cp',height:4,lineColor:'#41efff',scale:{start:0,end:100,stop:62},linkText:true,linkUnits:'exp',invertedProgress:true});
